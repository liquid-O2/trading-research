...
class Phase1LiveFixtureTests(unittest.TestCase):
    ...
    def test_cvd_smt_gex_news_are_pass(self):
        ...
        self.assertEqual(by["R-J20"]["impl_fidelity"], "pass")
        self.assertEqual(by["R-R01"]["impl_fidelity"], "pass")
        for rid in ("R-F02", "R-F07", "R-R04", "R-P18"):
            self.assertEqual(by[rid]["impl_fidelity"], "blocked", rid)
