...
def daily_benchmark_series(days: Sequence[Mapping[str, Any]]) -> list[DayReplay]:
    """Daily benchmark series producer. Removing the zero-entry rule breaks this consumer."""
    return replay_calendar(days)
