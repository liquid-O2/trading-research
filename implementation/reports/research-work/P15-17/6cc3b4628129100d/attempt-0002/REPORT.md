...
| --- | --- | --- | --- |
| candidates promoted | 0 | candidates of 148 supported / 5 outer folds, Holm across the stage | `attempt-0002/BREADTH_RESULTS.json#decisions` |
| best mean paired improvement | 25.7799 | net points per common complete day / 1094 days, 10325 resolved entries / [24.7714, 26.7971] / SIRES:absorption_reward_retest:S1 | `attempt-0002/BREADTH_RESULTS.json#decisions` |
| dispositions | {'retained_baseline': 38, 'rejected_by_evidence': 19, 'inconclusive_support': 91} | candidates | `attempt-0002/TRIALS.jsonl` |
| declared jobs reconciled | True | 278560 written + 160 absent = 278720 declared | `attempt-0002/RUN_COMPLETE.json` |
| hold-out days excluded | 112 | account days, 2026-04-01..2026-09-03 | `attempt-0002/BREADTH_RESULTS.json#holdout_excluded` |
...
**Smallest lever.** raise the entry count of the location-limited candidates before re-screening: the most common first attribution is location_miss (48 candidates), which Phase 3's improved locations address directly under the bounded-revisit rule
