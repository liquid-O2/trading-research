"""Write new immutable P15-00/P15-01/subphase artifacts after the v2 additional-review repair."""
...
def main() -> int:
    ...
    write_text(
        ...
        "\n".join(
            [
                "# P15-00 v3 work log",
                "",
                "Started after the 2026-09-14 v2 additional review. Assurance research-assurance-2026-09-14-v2.",
                "Supersedes 91ade001fb32cb9b as the current candidate without rewriting that attempt or v1 b291864ccceaca9a.",
    ...
    receipt01 = write_p15_01_receipt(
        ...
        reason="v3 verifier: fail-closed review bindings, matrix reconciliation, snapshot bytes, schema and lineage leaves",
    )
    ...
    subphase = {
        ...
        "reason": "v3 00-foundation: verifier rejects the 2026-09-14 additional-review invalid cases; v1 and v2 attempts preserved",
    }
        ...
        "commands": [
            {
                ...
                "log_path": str(results_copy),
                "log_sha256": file_digest(results_copy),
            }
        ],
        "code_snapshots": {
            "P15-00": {
