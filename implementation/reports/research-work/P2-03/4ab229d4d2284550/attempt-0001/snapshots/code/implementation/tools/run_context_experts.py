...
from trading_research.research.experts.options.atlas import build_atlas  # noqa: E402
...
def main() -> int:
    ...
    if args.task == "P2-09":
        ...
        boards_path = run_root / "EXPOSURE_BOARDS.json"
        if boards_path.is_file():
            boards = json.loads(boards_path.read_text()).get("boards") or []
            build_atlas(boards, run_root)
            result["atlas"] = True
