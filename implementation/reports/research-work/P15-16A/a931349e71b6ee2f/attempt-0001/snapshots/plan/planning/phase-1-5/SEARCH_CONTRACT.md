...
| Profile | P1 raw tick profile b0; P2 triangular b2; P3 raw b0 with value-area fraction .68; P4 raw b0 with value-area fraction .40 (P3 and P4 declared 2026-09-16 as a supplement before any of their results existed: .40 is the Sires printed intraday setting, .68 the one-sigma convention; the branch's source fraction stays the baseline) | Saint and Member profile references; Keani developing value; Sires balance references. Use the same causal formation. A supplement candidate whose fraction equals the branch's own source fraction is recorded as a duplicate of B0.2 and not run. |
...
| P value-area fraction | chosen fraction -.10, chosen, +.10, bounded to [.30,.90], at the chosen b and prominence |
