...
Acceptance amendment: `research-assurance-2026-09-14-v3`. Assigned cases: **S07, S11, S12, S14, S24, S30, S32**. The verifier cases S01 to S03 are cited from the P15-01 bound evidence, not re-probed here. Use the exact probes, expected results and evidence in SILENT_FAILURES.md. Reuse current bound shared evidence where applicable; do not replace the task’s own sensitive/native check with a test count. Preserve prior attempts and produce the common task artifacts listed in TASK_GRAPH.json as well as the task-specific outputs below.
...
- [ ] A09: Exit policies are compared without any hold-out date; the exit study records the exclusion.
