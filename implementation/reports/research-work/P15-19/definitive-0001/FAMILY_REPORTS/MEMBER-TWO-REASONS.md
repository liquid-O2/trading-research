...
| --- | --- | --- | --- | --- | --- |
| MEMBER-TWO-REASONS | MEMBER-TWO-REASONS:planned_return_long:P1|E1 | 434 | not claimed (no source-exact comparison) | rejected_by_evidence | /workspace/.worktrees/p15-17-fast/implementation/reports/research-work/P15-19/definitive-0001/FAMILY_REPORTS/MEMBER-TWO-REASONS.md |
| MEMBER-TWO-REASONS | MEMBER-TWO-REASONS:planned_return_long:P1|E2 | 434 | not claimed (no source-exact comparison) | retained_baseline | /workspace/.worktrees/p15-17-fast/implementation/reports/research-work/P15-19/definitive-0001/FAMILY_REPORTS/MEMBER-TWO-REASONS.md |
| MEMBER-TWO-REASONS | MEMBER-TWO-REASONS:planned_return_long:P1|E3 | 434 | not claimed (no source-exact comparison) | retained_baseline | /workspace/.worktrees/p15-17-fast/implementation/reports/research-work/P15-19/definitive-0001/FAMILY_REPORTS/MEMBER-TWO-REASONS.md |
| MEMBER-TWO-REASONS | MEMBER-TWO-REASONS:planned_return_long:P1|E4 | 434 | not claimed (no source-exact comparison) | retained_baseline | /workspace/.worktrees/p15-17-fast/implementation/reports/research-work/P15-19/definitive-0001/FAMILY_REPORTS/MEMBER-TWO-REASONS.md |
