...
def main() -> int:
    ...
    verifier_cases = {
        ...
        "cases": [
            ...
            {"id": "supersession_mid_chain_declared_hash", "expected_exit": 0, "code": None, "test": "test_supersession_mid_chain_declared_hash_accepted"},
            {"id": "supersession_mid_chain_without_later", "expected_exit": 2, "code": "IDENTITY", "test": "test_supersession_mid_chain_without_later_entry_rejected"},
            {"id": "supersession_mid_chain_wrong_later_previous", "expected_exit": 2, "code": "IDENTITY", "test": "test_supersession_mid_chain_wrong_later_previous_rejected"},
            {"id": "gate_review_mid_chain_graph_hash", "expected_exit": 0, "code": None, "test": "test_gate_review_mid_chain_graph_hash_accepted"},
            {"id": "gate_review_mid_chain_graph_hash_without_chain", "expected_exit": 2, "code": "GATE_REVIEW", "test": "test_gate_review_mid_chain_graph_hash_without_chain_rejected"},
            {"id": "supersession_predating_entry", "expected_exit": 0, "code": "IDENTITY", "test": "test_supersession_predating_entry_skipped_unless_successor"},
        ],
    }
    ...
    review = {
        ...
        "findings": [
            ...
            },
            {
                "id": "F07",
                "severity": "integrity",
                "summary": "Plan-file live mismatch verifies through an ordered AMENDMENTS.json chain starting at the declared hash; code-file live mismatch verifies through a later verified successor receipt. Assurance version mismatch is IDENTITY. Gate-review graph binding follows the same walk.",
                "reproduction": "test_supersession_mid_chain_declared_hash_accepted and sibling rejection tests",
                "affected_outputs": [str(ROOT / "implementation/src/trading_research/research/contracts/receipts.py")],
                "resolution": "resolved",
                "resolution_evidence": "mid-chain, predating-skip, and gate-review graph-hash tests with isolated FailureCode IDENTITY/GATE_REVIEW and passing controls",
            },
        ],
