...
| --- | --- | --- | --- | --- | --- |
| KEANI-OPEN-ABOVE-VALUE | KEANI-OPEN-ABOVE-VALUE:source_long:P4:bandwidth=0 | 1107 | not claimed (no source-exact comparison) | inconclusive_support | /workspace/.worktrees/p15-17-fast/implementation/reports/research-work/P15-18/4f4fcccf0ed8d0e9/attempt-0001/FAMILY_REPORTS/KEANI-OPEN-ABOVE-VALUE.md |
| KEANI-OPEN-ABOVE-VALUE | KEANI-OPEN-ABOVE-VALUE:source_long:S4:favorable_ticks=1 | 1107 | not claimed (no source-exact comparison) | inconclusive_support | /workspace/.worktrees/p15-17-fast/implementation/reports/research-work/P15-18/4f4fcccf0ed8d0e9/attempt-0001/FAMILY_REPORTS/KEANI-OPEN-ABOVE-VALUE.md |
