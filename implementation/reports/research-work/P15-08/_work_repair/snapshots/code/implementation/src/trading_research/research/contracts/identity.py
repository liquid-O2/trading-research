...
def validate_receipt_shape(receipt: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if not isinstance(receipt.get("assurance_version"), str) or not receipt.get("assurance_version"):
        raise ContractError("assurance_version must be a nonempty string")
