...
ROOTS: dict[str, RootSpec] = {
    ...
    "NQ": _spec(
        ...
        exercise="american",
        settlement="future",
        expiry_session="definition_expiration",
        expiry_hour_et=16,
        expiry_minute_et=0,
        pricing_model="black76",
        quote_tick=NQ_TICK,
        strike_tick=NQ_TICK,
        option_style_source="owned_databento_definition_cfi",
        theta_prefix=None,
...
def ledger_document() -> dict[str, object]:
    ...
    return {
        ...
        "notes": [
            ...
            "NQ/ES option definitions, open interest and 1-minute last-trade quotes are decoded from owned Databento DBN files with the official databento package.",
        ],
    }
