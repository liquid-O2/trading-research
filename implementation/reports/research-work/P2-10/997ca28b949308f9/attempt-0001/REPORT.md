...
1711 atlas row-days + 31 listed missing = 1742 census dates; identity=True.

NQ and ES cells are labelled degenerate board (median n_live 2 / 7) and are not evidence for the futures-option levels thesis until a BBO or MBP schema is owned.

Headline after-availability high-within-8 (QQQ+SPY): 0.003862982380070164 n=25369. Superseded unrestricted diagnostic: 0.004126698421757359 n=45557.
