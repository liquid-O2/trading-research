...
The scanner walked one break per level (the first close through) and its first touch; on 2026-08-10 that was the failed 18:21 break of 29,738.5, so his 18:31 break and 19:47 retest were never examined. It now walks every break-and-retest cycle of every level with the rule the ticket replay was accepted on, extracted into `source_adapters/break_retest.py` and shared with `replay_sires.py` (still 20 of 20 strict): a break after a close inside, a 24-point departure, the retest within 14 points from the broken side, a close back through by more than a point ends the cycle, three retests at most, one episode per level and retest bar. The fill is the retest's extreme and the stop a tick through the broken level (his stop box 29,729-29,736.75 under the 29,740 line; the balance-edge stop was 221 points). On the fixture-free scan his ticket comes out at 19:48 short 29,726.75 on the 29,734.5 line, passing every stage (his 19:51 at 29,729.25). The session holds 33 all-stage passes on both sides of the continuation branch: the generated level set is the candidate list, his one trade among them is the grading layer's, as for Jumbo and Green Bird.
