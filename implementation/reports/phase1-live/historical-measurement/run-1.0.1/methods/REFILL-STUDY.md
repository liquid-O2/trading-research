# REFILL-STUDY — full acquired Phase 1 measurement
...
| --- | --- | --- | --- | --- | --- | --- |
| touch_record | context_or_research | 1742 | 0 | 0 | 0 | 10 |
| supplied_selected_order | personal_execution_out_of_scope | 1742 | 0 | 0 | 0 | 0 |
| selected_order_configuration | personal_execution_out_of_scope | 1742 | 0 | 0 | 0 | 0 |
...
Source: REF pp.5–9;OFM pp.15–18; large execution cluster → immutable zone → departure → distinct return with pre-touch memory → later label.
...
## supplied_selected_order

Source: REF p.12,16;OFM p.18; actual supplied model selection → 12/32/96 tick configuration → 30 minute cancel → one position → actual lifecycle/cost audit.
...
## selected_order_configuration

Source: FORMULAS:M09; selected_order_configuration process/management unit.
