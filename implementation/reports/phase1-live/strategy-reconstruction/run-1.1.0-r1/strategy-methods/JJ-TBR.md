...
Observed entry candidates: 16 setup, 74 no setup, 0 unavailable market input. Separately retained context/process observations: 0. No personal quantity, account limit or executed-order history gates these setup results.
...
| --- | --- | --- | --- |
| other_session | no_setup | source_confirmation | 40 |
| other_session | no_setup | risk_defined | 14 |
| timed_pzone_reversal | no_setup | source_confirmation | 11 |
...
| judas_outbound | no_setup | risk_defined | 3 |
| internal_rotation | no_setup | source_confirmation | 3 |
...
| single_extended | no_setup | source_confirmation | 2 |
| single_purged | no_setup | source_confirmation | 2 |
| judas_reversal | no_setup | risk_defined | 1 |
| single_extended | no_setup | risk_defined | 1 |
| single_purged | no_setup | risk_defined | 1 |
| internal_rotation | no_setup | risk_defined | 1 |
| internal_rotation | no_setup | objective_fixed | 1 |

Full episode values, inferred-model receipts and legacy source-audit comparisons: [native report](/workspace/implementation/reports/phase1-live/strategy-reconstruction/run-1.1.0-r1/methods/JJ-TBR.md). [Versioned policy](/workspace/implementation/reports/phase1-live/strategy-reconstruction/run-1.1.0-r1/registry/STRATEGY_POLICY.json).
