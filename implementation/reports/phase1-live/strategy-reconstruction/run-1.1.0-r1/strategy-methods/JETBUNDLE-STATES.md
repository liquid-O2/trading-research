...
Observed entry candidates: 0 setup, 0 no setup, 0 unavailable market input. Separately retained context/process observations: 30. No personal quantity, account limit or executed-order history gates these setup results.
