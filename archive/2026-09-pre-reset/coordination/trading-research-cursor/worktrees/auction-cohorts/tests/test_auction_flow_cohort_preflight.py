...
CONTRACT_PATH = Path(__file__).resolve().parents[1] / 'controller_inputs' / 'auction-cohort-preflight-contract.json'
...
class AuctionFlowCohortPreflightTests(unittest.TestCase):
    ...
    def test_scalar_timestamp_trim_keeps_full_main_paths(self):
        ...
        with TemporaryDirectory() as folder:
            ...
            self.assertEqual(summary['workload_counts']['scalar_reference_sliced_prints'], 4095)
