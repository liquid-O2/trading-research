...
CHECK_EXTENSION = ROOT / 'validation/AUCTION_FLOW_SOURCE_CHECK_EXTENSION_V22.json'
...
def production_compatibility(authenticated):
    ...
    configure_verified_compatibility(previous=contract['previous_quote_implementation'],
                                    current=contract['current_quote_implementation'])
    return (contract['previous_producer'],)
