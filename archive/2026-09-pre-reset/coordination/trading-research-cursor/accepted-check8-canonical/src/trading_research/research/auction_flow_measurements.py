...
class _ValidatedTradeArrays:
    ...
    Only _validated_trade_arrays may construct this handle. It is not a raw
...
def _validated_trade_arrays(*, size, side, event_ns, source_order):
...
def _add_validated_trade_arrays(flow, prepared):
...
class OrderedFlow:
    ...
    def add(self, *, size, side, event_ns, source_order):
        _add_validated_trade_arrays(self, _validated_trade_arrays(
