...
CHECK_EXTENSION = ROOT / 'validation/AUCTION_FLOW_SOURCE_CHECK_EXTENSION_V37.json'
...
REGISTERED_MODES = ('check', 'profile', 'benchmark', 'compute', 'downstream', 'throughput',
                    'clock-audit', 'source-clock', 'extract', 'extract-check', 'observations', 'core-statistics', 'window-links')
...
def parent(mode='check'):
    ...
    trial = registry.register(name='Acquired auction/flow: ' + (
        ...
        family=protocol['family'], stage='representation' if mode == 'core-statistics' else 'engineering', configuration=configuration, code_hash=snapshot.sha256,
