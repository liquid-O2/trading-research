...
CHECK_EXTENSION = ROOT / 'validation/AUCTION_FLOW_SOURCE_CHECK_EXTENSION_V33.json'
...
REGISTERED_MODES = ('check', 'profile', 'benchmark', 'compute', 'downstream', 'throughput',
                    'clock-audit', 'source-clock', 'extract', 'extract-check', 'observations', 'core-statistics')
...
def limits(protocol, mode='check', *, extension=None):
    ...
    if mode in ('observations', 'core-statistics'):
