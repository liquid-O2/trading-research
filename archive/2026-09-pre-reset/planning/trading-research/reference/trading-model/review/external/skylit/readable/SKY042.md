...
````yaml /flowseeker-openapi.yaml get /v1/market/overview
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/MarketOverviewSuccess'
        '400':
    ...
    MarketOverviewResponse:
      ...
      properties:
        ...
        premiumRvol:
          type: number
          description: >-
            Premium relative to the trailing 20-day baseline at this time of
            day.
        topTickers:
          type: array
          maxItems: 10
          items:
            $ref: '#/components/schemas/TopTickerSummary'
    Meta:
      type: object
      required:
        - timestamp
