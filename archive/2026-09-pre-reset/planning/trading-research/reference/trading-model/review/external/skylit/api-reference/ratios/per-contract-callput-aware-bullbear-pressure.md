...
````yaml /flowseeker-openapi.yaml get /v1/contract-bull-bear/{symbol}
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ContractBullBearSuccess'
        '400':
...
components:
  ...
  schemas:
    ContractBullBearSuccess:
      ...
      properties:
        data:
          $ref: '#/components/schemas/ContractBullBearResponse'
        meta:
    ...
    ContractBullBearResponse:
      ...
      properties:
        ...
        totalPremium:
          type: number
        metrics:
          $ref: '#/components/schemas/ContractBullBearMetrics'
        interpretation:
