...
````yaml /flowseeker-openapi.yaml get /v1/sweeps/{ticker}
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/SweepSuccess'
        '400':
    ...
    SweepResponse:
      ...
      properties:
        ...
        sweeps:
          type: array
          items:
            $ref: '#/components/schemas/SweepItem'
        summary:
          $ref: '#/components/schemas/SweepSummary'
    Meta:
      type: object
      required:
        - timestamp
      ...
      properties:
        ...
        moneyness:
          ...
          enum:
            ...
            - DEEP_OTM
        scores:
          $ref: '#/components/schemas/SweepScores'
    SweepSummary:
      type: object
      required:
        - totalSweeps
      ...
      properties:
        totalSweeps:
          ...
          minimum: 0
          description: >-
            Estimated total logical sweeps for the day (population, not just
            `returnedCount`).
        bullishSweeps:
          type: integer
          minimum: 0
    ...
    SweepScores:
      ...
      properties:
        ...
        flowBonus:
          ...
          minimum: 0
          maximum: 100
          description: Conviction bonus (multi-exchange, OTM, premium size).
  responses:
    BadRequest:
