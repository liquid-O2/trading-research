...
````yaml /flowseeker-openapi.yaml get /v1/underlying/{ticker}/rvol
openapi: 3.1.0
info:
    ...
    get:
      ...
      parameters:
        ...
        - in: query
          name: order
          description: >-
            Sort direction. Defaults to `asc` when `order_by=time`, otherwise
            `desc`.
          schema:
            type: string
            enum:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/UnderlyingRvolSuccess'
        '400':
...
components:
  ...
  schemas:
    UnderlyingRvolSuccess:
      ...
      properties:
        data:
          $ref: '#/components/schemas/UnderlyingRvolResponse'
        meta:
    ...
    UnderlyingRvolResponse:
      ...
      properties:
        bars:
          type: array
          items:
            $ref: '#/components/schemas/UnderlyingRvolBar'
        stats:
          $ref: '#/components/schemas/RvolStats'
        callRvol:
          type: number
          format: double
