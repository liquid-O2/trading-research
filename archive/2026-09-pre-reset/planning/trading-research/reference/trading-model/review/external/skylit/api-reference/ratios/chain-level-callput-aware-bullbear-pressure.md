...
````yaml /flowseeker-openapi.yaml get /v1/chain-bull-bear/{ticker}
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ChainBullBearSuccess'
        '400':
...
components:
  ...
  schemas:
    ChainBullBearSuccess:
      ...
      properties:
        data:
          $ref: '#/components/schemas/ChainBullBearResponse'
        meta:
    ...
    ChainBullBearResponse:
      ...
      properties:
        ...
        totalPremium:
          type: number
        metrics:
          $ref: '#/components/schemas/ChainBullBearMetrics'
        interpretation:
          $ref: '#/components/schemas/BullBearInterpretation'
    Meta:
      type: object
      required:
        - timestamp
    ...
    ChainBullBearMetrics:
      ...
      properties:
        bullPct:
          type: number
          description: Share (0–100) of volume classified as bullish.
        bearPct:
          type: number
        neutralPct:
          type: number
        ...
        putBullPct:
          type: number
          description: >-
            Bullish share within puts only (high = put selling = contrarian
            bullish).
