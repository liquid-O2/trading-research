...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 2 or sys.argv[1] not in ('check', 'profile', 'benchmark', 'compute', 'downstream', 'throughput', 'clock-audit', 'source-clock'):
        raise SystemExit('usage: run_auction_flow_study.py {check|profile|benchmark|compute|downstream|throughput|clock-audit|source-clock}')
