...
CHECK_EXTENSION = ROOT / 'validation/AUCTION_FLOW_SOURCE_CHECK_EXTENSION_V10.json'
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 2 or sys.argv[1] not in ('check', 'profile', 'benchmark', 'compute'):
        raise SystemExit('usage: run_auction_flow_study.py {check|profile|benchmark|compute}')
