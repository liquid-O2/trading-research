...
def _add_slices(window, index, start_ns, end_ns, counts, *, contribution=True, slice_key='sliced_prints'):
    added = 0
        ...
        for instrument in instruments:
            ...
            for item in plan:
                ...
                if not prefix:
                    ...
                    added = _add_slices(prefix_window, index, supported_start, prefix_end, counts,
