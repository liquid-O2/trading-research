...
def parent(mode, parent_report=None, phase=None, resource_authorization=None):
    ...
    try:
        ...
        joined = worker_value is not None and all(worker_value.get(k) == packet[k] for k in
                  ("trial_id", "attempt_id", "protocol_sha256", "code_snapshot", "tools_snapshot", "mode", "phase", "analysis_plan", "execution_plan", "model_plan", "verification_contracts", "resource_amendment", "hardware_execution"))
