...
def descriptive_confirmation_from_predecessor(predecessor):
...
def authenticate_descriptive_confirmation(flag, predecessor, configured=None):
    """Packet flag must match the registered trial and the exact predecessor."""
    expected = descriptive_confirmation_from_predecessor(predecessor)
