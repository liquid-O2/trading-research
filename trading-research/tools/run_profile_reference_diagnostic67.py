...
base.CHECK_EXTENSION = base.ROOT / 'validation/AUCTION_FLOW_SOURCE_CHECK_EXTENSION_V58.json'
...
def diagnose(authenticated,packet_path):
    ...
    outputs=BoundedOutputs(Path(packet_path).parent/'outputs',maximum_total_bytes=cap['maximum_output_bytes']-cap['supervisor_output_reserve_bytes'],maximum_file_bytes=min(cap['maximum_output_file_bytes'],cap['maximum_output_bytes']-cap['supervisor_output_reserve_bytes']))
