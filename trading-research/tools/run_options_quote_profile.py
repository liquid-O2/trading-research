"""Registered 120 CPU-second statistics diagnostic from failed quote pilot8 output."""
...
DIAG = Path('/workspace/coordination/trading-research-cursor/options-quotes8-diagnosis.json')
DIAG_SHA = '0ae1b5c442c9809c7564cde5e8b97fe39590dc0af45c7fab6a70ca781129a391'
...
def profiled(packet, protocol, store, outputs):
    ...
    ref = diagnostic['date_aggregates']
    path = Path(ref['path'])
    ...
    rows = stats.load_date_aggregates(ref)
