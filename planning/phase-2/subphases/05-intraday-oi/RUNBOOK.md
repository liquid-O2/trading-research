# Phase 2 / 05-intraday-oi — coordinator runbook
...
Source content SHA256: `c0ecf740e5b3252ed86ebf951dd4dc2da33a8603b9deb16a24a6aefe8435705b`.

Previous gate: **04-context-mechanisms**. External task dependencies: P2-11. Read and verify their actual receipts before implementation.
...
| --- | --- | --- |
| P2-12 — Fit and test weakly supervised intraday OI updates | P2-11 | [Task](/workspace/planning/phase-2/tasks/P2-12.md) |
...
This runbook includes only cases assigned to: P2-12.
...
Acceptance amendment: `research-assurance-2026-09-14-v2`. Assigned cases: **S01, S02, S03, S07, S08, S11, S12, S13, S14, S15, S16, S17, S18, S19, S25, S26, S27, S28, S32**. Use the exact probes, expected results and evidence in SILENT_FAILURES.md. Reuse current bound shared evidence where applicable; do not replace the task’s own sensitive/native check with a test count. Preserve prior attempts and produce the common task artifacts listed in TASK_GRAPH.json as well as the task-specific outputs below.
...
```text
/poteto-mode new task. Implement this feature: P2-12 — Fit and test weakly supervised intraday OI updates.
Read /workspace/planning/phase-2/tasks/P2-12.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
