...
Source content SHA256: `f9a4acabbb567d89ca26d5a99f3430cc978b9976fd81814183e299550c2620ae`.

Previous gate: **02-native-options-baseline**. External task dependencies: P2-02, P2-10. Read and verify their actual receipts before implementation.
...
| --- | --- | --- |
| P2-03 — Implement volatility arithmetic and multi-horizon targets | P2-02, P2-10 | [Task](/workspace/planning/phase-2/tasks/P2-03.md) |
| P2-04 — Fit one joint volatility expert and its ablations | P2-03 | [Task](/workspace/planning/phase-2/tasks/P2-04.md) |
...
Subphase: `03-joint-volatility`. Dependencies: P2-02, P2-10.
...
Consume verified predecessor receipts: **P2-02, P2-10**. Their hashes and actual artifact paths go in this task receipt. Required schema details are in DATA_CONTRACTS; source adapters also read their named method predicates.
...
Subphase: `03-joint-volatility`. Dependencies: P2-03.
...
Consume verified predecessor receipts: **P2-03**. Their hashes and actual artifact paths go in this task receipt. Required schema details are in DATA_CONTRACTS; source adapters also read their named method predicates.
