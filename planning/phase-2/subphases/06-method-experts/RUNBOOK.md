# Phase 2 / 06-method-experts — coordinator runbook
...
Source content SHA256: `0953f4055c514e2d9e70be9c7d4424cea3f4f674576159ba2ed1b53459de1cee`.

Previous gate: **05-intraday-oi**. External task dependencies: P2-05, P2-06, P2-07, P2-08, P2-12. Read and verify their actual receipts before implementation.
...
| --- | --- | --- |
| P2-13 — Jumbo context expert | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-13.md) |
| P2-14 — Green Bird failure context expert | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-14.md) |
| P2-15 — Green Bird VWAP context expert | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-15.md) |
| P2-16 — Green Bird scalps context expert | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-16.md) |
| P2-17 — Sires context expert | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-17.md) |
| P2-18 — Saint context expert | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-18.md) |
| P2-19 — Member two reasons context expert | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-19.md) |
| P2-20 — Keani context expert | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-20.md) |
| P2-21 — Build research-process context and risk overlay interfaces | P2-05, P2-06, P2-07, P2-08, P2-12 | [Task](/workspace/planning/phase-2/tasks/P2-21.md) |
...
This runbook includes only cases assigned to: P2-13, P2-14, P2-15, P2-16, P2-17, P2-18, P2-19, P2-20, P2-21.
...
Assigned tasks: P15-04, P15-09, P15-10, P15-11, P15-12, P15-13, P15-14, P15-15, P15-16, P2-13, P2-14, P2-15, P2-16, P2-17, P2-18, P2-19, P2-20.
...
Canonical source: [CONTEXT.md](/workspace/planning/phase-2/CONTEXT.md).
...
Canonical source: [P2-13.md](/workspace/planning/phase-2/tasks/P2-13.md).

## P2-13 — Jumbo context expert
...
Implement a separate JJ-TBR expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
...
- [method-jumbo-tbr.md](/workspace/wiki/method-jumbo-tbr.md)
...
- `/workspace/implementation/src/trading_research/research/experts/methods/jumbo.py`
- `/workspace/implementation/src/trading_research/research/experts/configs/method_jumbo.json`
- `/workspace/implementation/tests/context_experts/test_p2_13.py`
...
1. Implement a separate JJ-TBR expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
...
Acceptance amendment: `research-assurance-2026-09-14-v2`. Assigned cases: **S01, S02, S03, S07, S08, S11, S15, S17, S18, S19, S20, S21, S28, S32**. Use the exact probes, expected results and evidence in SILENT_FAILURES.md. Reuse current bound shared evidence where applicable; do not replace the task’s own sensitive/native check with a test count. Preserve prior attempts and produce the common task artifacts listed in TASK_GRAPH.json as well as the task-specific outputs below.

### Acceptance checklist

- [ ] A01: All eight branches retain separate occurrence/suitability and timing masks.
- [ ] A02: Pre-open features cannot use the final overnight purge/path explanation.
- [ ] A03: Outbound deadline/P-zone baseline identity stay source constrained.
...
.venv/bin/python -m pytest /workspace/implementation/tests/context_experts/test_p2_13.py -q
```
...
```bash
/workspace/implementation/.venv/bin/python /workspace/implementation/tools/run_context_experts.py slice --run-root RUN_ROOT --manifest FROZEN_MANIFEST --dates FROZEN_DATES --task P2-13
```
...
```text
/poteto-mode new task. Implement this feature: P2-13 — Jumbo context expert.
Read /workspace/planning/phase-2/tasks/P2-13.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
...
Canonical source: [P2-14.md](/workspace/planning/phase-2/tasks/P2-14.md).

## P2-14 — Green Bird failure context expert
...
Implement a separate GB-FAIL expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
...
- [OUTCOMES.md](/workspace/planning/research-program/OUTCOMES.md)
- [DATA_CONTRACTS.md](/workspace/planning/research-program/DATA_CONTRACTS.md)
- [method-green-bird-failure.md](/workspace/wiki/method-green-bird-failure.md)
...
- `/workspace/implementation/src/trading_research/research/experts/methods/green_failure.py`
- `/workspace/implementation/src/trading_research/research/experts/configs/method_green_failure.json`
- `/workspace/implementation/tests/context_experts/test_p2_14.py`

A worker does not edit another task’s shared files. Request an explicit integration patch from the subphase coordinator for runner registration, imports or additive shared-schema changes; the coordinator records it and reruns the affected contract tests. Keep independently fitted artifacts separate even when calculators are shared.

### Implementation steps

1. Implement a separate GB-FAIL expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
2. Build branch occurrence-grid and pre-opportunity conditional utility/path targets, selecting first future qualifying setup deterministically. Include complete no-setup rows and separate masks.
3. Consume causal upstream forecasts including OI B0/B1/B2 identities, preserve source clocks and selected-rule cutoff, run method-specific ablations/support and native examples.
4. Trace one actual output through its serialized schema, feature/stage parents and native receipt. Then run the verification below and write immutable evidence. A formula unit test alone does not complete a native-data or fitted-expert task.
...
- [ ] A01: Sweep-entry and reclaim alternatives keep their own available clocks.
- [ ] A02: Prior hour/day/week/month source references remain distinguishable.
- [ ] A03: Supplemental refinement is not counted as an independent entry method.
- [ ] A04: No all-history selected rule or in-sample upstream forecast enters historical training/test rows.
- [ ] A05: A low-support branch returns the declared prior/baseline and all counts, not a fitted-success claim.
- [ ] A06: Evidence includes command exit codes, artifact hashes, coverage/unknown counts, runtime, actual output inspection and the task’s declared limitations. All predecessor receipts verify.
...
```bash
cd /workspace/implementation
.venv/bin/python -m pytest /workspace/implementation/tests/context_experts/test_p2_14.py -q
```

Then run the frozen engineering slice with the actual manifest and date list produced by the prerequisite (substitute the three ALL_CAPS paths/values; do not invent dates from outcomes):

```bash
/workspace/implementation/.venv/bin/python /workspace/implementation/tools/run_context_experts.py slice --run-root RUN_ROOT --manifest FROZEN_MANIFEST --dates FROZEN_DATES --task P2-14
```
...
```text
/poteto-mode new task. Implement this feature: P2-14 — Green Bird failure context expert.
Read /workspace/planning/phase-2/tasks/P2-14.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
Use the coordinator's actual working root, code identity, predecessor receipt paths/hashes, frozen manifest, dates and run root. Resolve missing values from those artifacts; report unresolved fields to the coordinator instead of inventing them.
Use the parent Grok model for every pstack role (inherit-parent means omit model). Use the installed poteto-agent wrapper when supported. No nested delegation; the coordinator owns fresh review and shared-file integration. Respect its single-writer checkout assignment.
Follow the exact formulas, clocks, schemas, allowed paths, finite budgets and A01, A02, A03, A04, A05, A06, A07, A08 checks. Name the data shape, implement one vertical behavior, run sensitive tests and the declared native slice/full run, and inspect actual output.
Done means all required artifacts exist and verify_research_release.py task exits 0 on the actual TASK_RECEIPT.json, with truthful coverage and disposition. Return real artifact paths, command results, decision-trail path and limitations. Keep runtime todos in the run's WORK_LOG.md and record playbook skips there.
...
Canonical source: [P2-15.md](/workspace/planning/phase-2/tasks/P2-15.md).

## P2-15 — Green Bird VWAP context expert
...
Implement a separate GB-VWAP expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
...
- [OUTCOMES.md](/workspace/planning/research-program/OUTCOMES.md)
- [DATA_CONTRACTS.md](/workspace/planning/research-program/DATA_CONTRACTS.md)
- [method-green-bird-vwap-continuation.md](/workspace/wiki/method-green-bird-vwap-continuation.md)
...
- `/workspace/implementation/src/trading_research/research/experts/methods/green_vwap.py`
- `/workspace/implementation/src/trading_research/research/experts/configs/method_green_vwap.json`
- `/workspace/implementation/tests/context_experts/test_p2_15.py`

A worker does not edit another task’s shared files. Request an explicit integration patch from the subphase coordinator for runner registration, imports or additive shared-schema changes; the coordinator records it and reruns the affected contract tests. Keep independently fitted artifacts separate even when calculators are shared.

### Implementation steps

1. Implement a separate GB-VWAP expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
2. Build branch occurrence-grid and pre-opportunity conditional utility/path targets, selecting first future qualifying setup deterministically. Include complete no-setup rows and separate masks.
3. Consume causal upstream forecasts including OI B0/B1/B2 identities, preserve source clocks and selected-rule cutoff, run method-specific ablations/support and native examples.
4. Trace one actual output through its serialized schema, feature/stage parents and native receipt. Then run the verification below and write immutable evidence. A formula unit test alone does not complete a native-data or fitted-expert task.
...
- [ ] A01: Source-long prerequisite is not silently relaxed by a favorable context score.
- [ ] A02: A custom short variant keeps a custom source label.
- [ ] A03: VWAP age/anchor and remaining expansion are consumed and ablated.
- [ ] A04: No all-history selected rule or in-sample upstream forecast enters historical training/test rows.
- [ ] A05: A low-support branch returns the declared prior/baseline and all counts, not a fitted-success claim.
- [ ] A06: Evidence includes command exit codes, artifact hashes, coverage/unknown counts, runtime, actual output inspection and the task’s declared limitations. All predecessor receipts verify.
...
```bash
cd /workspace/implementation
.venv/bin/python -m pytest /workspace/implementation/tests/context_experts/test_p2_15.py -q
```

Then run the frozen engineering slice with the actual manifest and date list produced by the prerequisite (substitute the three ALL_CAPS paths/values; do not invent dates from outcomes):

```bash
/workspace/implementation/.venv/bin/python /workspace/implementation/tools/run_context_experts.py slice --run-root RUN_ROOT --manifest FROZEN_MANIFEST --dates FROZEN_DATES --task P2-15
```
...
```text
/poteto-mode new task. Implement this feature: P2-15 — Green Bird VWAP context expert.
Read /workspace/planning/phase-2/tasks/P2-15.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
Use the coordinator's actual working root, code identity, predecessor receipt paths/hashes, frozen manifest, dates and run root. Resolve missing values from those artifacts; report unresolved fields to the coordinator instead of inventing them.
Use the parent Grok model for every pstack role (inherit-parent means omit model). Use the installed poteto-agent wrapper when supported. No nested delegation; the coordinator owns fresh review and shared-file integration. Respect its single-writer checkout assignment.
Follow the exact formulas, clocks, schemas, allowed paths, finite budgets and A01, A02, A03, A04, A05, A06, A07, A08 checks. Name the data shape, implement one vertical behavior, run sensitive tests and the declared native slice/full run, and inspect actual output.
Done means all required artifacts exist and verify_research_release.py task exits 0 on the actual TASK_RECEIPT.json, with truthful coverage and disposition. Return real artifact paths, command results, decision-trail path and limitations. Keep runtime todos in the run's WORK_LOG.md and record playbook skips there.
...
Canonical source: [P2-16.md](/workspace/planning/phase-2/tasks/P2-16.md).

## P2-16 — Green Bird scalps context expert
...
Implement a separate GB-SCALP expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
...
- [OUTCOMES.md](/workspace/planning/research-program/OUTCOMES.md)
- [DATA_CONTRACTS.md](/workspace/planning/research-program/DATA_CONTRACTS.md)
- [method-green-bird-directional-scalps.md](/workspace/wiki/method-green-bird-directional-scalps.md)
...
- `/workspace/implementation/src/trading_research/research/experts/methods/green_scalp.py`
- `/workspace/implementation/src/trading_research/research/experts/configs/method_green_scalp.json`
- `/workspace/implementation/tests/context_experts/test_p2_16.py`

A worker does not edit another task’s shared files. Request an explicit integration patch from the subphase coordinator for runner registration, imports or additive shared-schema changes; the coordinator records it and reruns the affected contract tests. Keep independently fitted artifacts separate even when calculators are shared.

### Implementation steps

1. Implement a separate GB-SCALP expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
2. Build branch occurrence-grid and pre-opportunity conditional utility/path targets, selecting first future qualifying setup deterministically. Include complete no-setup rows and separate masks.
3. Consume causal upstream forecasts including OI B0/B1/B2 identities, preserve source clocks and selected-rule cutoff, run method-specific ablations/support and native examples.
4. Trace one actual output through its serialized schema, feature/stage parents and native receipt. Then run the verification below and write immutable evidence. A formula unit test alone does not complete a native-data or fitted-expert task.
...
- [ ] A01: Both direction branches have mirrored fixture coverage.
- [ ] A02: Incomplete proprietary automatic admission remains explicit.
- [ ] A03: Later confirmation delay is a measured input history, not a future label.
- [ ] A04: No all-history selected rule or in-sample upstream forecast enters historical training/test rows.
- [ ] A05: A low-support branch returns the declared prior/baseline and all counts, not a fitted-success claim.
- [ ] A06: Evidence includes command exit codes, artifact hashes, coverage/unknown counts, runtime, actual output inspection and the task’s declared limitations. All predecessor receipts verify.
...
```bash
cd /workspace/implementation
.venv/bin/python -m pytest /workspace/implementation/tests/context_experts/test_p2_16.py -q
```

Then run the frozen engineering slice with the actual manifest and date list produced by the prerequisite (substitute the three ALL_CAPS paths/values; do not invent dates from outcomes):

```bash
/workspace/implementation/.venv/bin/python /workspace/implementation/tools/run_context_experts.py slice --run-root RUN_ROOT --manifest FROZEN_MANIFEST --dates FROZEN_DATES --task P2-16
```
...
```text
/poteto-mode new task. Implement this feature: P2-16 — Green Bird scalps context expert.
Read /workspace/planning/phase-2/tasks/P2-16.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
Use the coordinator's actual working root, code identity, predecessor receipt paths/hashes, frozen manifest, dates and run root. Resolve missing values from those artifacts; report unresolved fields to the coordinator instead of inventing them.
Use the parent Grok model for every pstack role (inherit-parent means omit model). Use the installed poteto-agent wrapper when supported. No nested delegation; the coordinator owns fresh review and shared-file integration. Respect its single-writer checkout assignment.
Follow the exact formulas, clocks, schemas, allowed paths, finite budgets and A01, A02, A03, A04, A05, A06, A07, A08 checks. Name the data shape, implement one vertical behavior, run sensitive tests and the declared native slice/full run, and inspect actual output.
Done means all required artifacts exist and verify_research_release.py task exits 0 on the actual TASK_RECEIPT.json, with truthful coverage and disposition. Return real artifact paths, command results, decision-trail path and limitations. Keep runtime todos in the run's WORK_LOG.md and record playbook skips there.
...
Canonical source: [P2-17.md](/workspace/planning/phase-2/tasks/P2-17.md).
...
Canonical source: [P2-18.md](/workspace/planning/phase-2/tasks/P2-18.md).

## P2-18 — Saint context expert
...
Implement a separate SAINT-AMT expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
...
- [OUTCOMES.md](/workspace/planning/research-program/OUTCOMES.md)
- [DATA_CONTRACTS.md](/workspace/planning/research-program/DATA_CONTRACTS.md)
- [method-saint-amt.md](/workspace/wiki/method-saint-amt.md)
...
- `/workspace/implementation/src/trading_research/research/experts/methods/saint.py`
- `/workspace/implementation/src/trading_research/research/experts/configs/method_saint.json`
- `/workspace/implementation/tests/context_experts/test_p2_18.py`

A worker does not edit another task’s shared files. Request an explicit integration patch from the subphase coordinator for runner registration, imports or additive shared-schema changes; the coordinator records it and reruns the affected contract tests. Keep independently fitted artifacts separate even when calculators are shared.

### Implementation steps

1. Implement a separate SAINT-AMT expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
2. Build branch occurrence-grid and pre-opportunity conditional utility/path targets, selecting first future qualifying setup deterministically. Include complete no-setup rows and separate masks.
3. Consume causal upstream forecasts including OI B0/B1/B2 identities, preserve source clocks and selected-rule cutoff, run method-specific ablations/support and native examples.
4. Trace one actual output through its serialized schema, feature/stage parents and native receipt. Then run the verification below and write immutable evidence. A formula unit test alone does not complete a native-data or fitted-expert task.
...
- [ ] A01: HTF/LTF availability and agreement are independent.
- [ ] A02: Four route labels are not collapsed into generic trend/balance.
- [ ] A03: Source control/retest prerequisites persist under context scoring.
- [ ] A04: No all-history selected rule or in-sample upstream forecast enters historical training/test rows.
- [ ] A05: A low-support branch returns the declared prior/baseline and all counts, not a fitted-success claim.
- [ ] A06: Evidence includes command exit codes, artifact hashes, coverage/unknown counts, runtime, actual output inspection and the task’s declared limitations. All predecessor receipts verify.
...
```bash
cd /workspace/implementation
.venv/bin/python -m pytest /workspace/implementation/tests/context_experts/test_p2_18.py -q
```

Then run the frozen engineering slice with the actual manifest and date list produced by the prerequisite (substitute the three ALL_CAPS paths/values; do not invent dates from outcomes):

```bash
/workspace/implementation/.venv/bin/python /workspace/implementation/tools/run_context_experts.py slice --run-root RUN_ROOT --manifest FROZEN_MANIFEST --dates FROZEN_DATES --task P2-18
```
...
```text
/poteto-mode new task. Implement this feature: P2-18 — Saint context expert.
Read /workspace/planning/phase-2/tasks/P2-18.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
Use the coordinator's actual working root, code identity, predecessor receipt paths/hashes, frozen manifest, dates and run root. Resolve missing values from those artifacts; report unresolved fields to the coordinator instead of inventing them.
Use the parent Grok model for every pstack role (inherit-parent means omit model). Use the installed poteto-agent wrapper when supported. No nested delegation; the coordinator owns fresh review and shared-file integration. Respect its single-writer checkout assignment.
Follow the exact formulas, clocks, schemas, allowed paths, finite budgets and A01, A02, A03, A04, A05, A06, A07, A08 checks. Name the data shape, implement one vertical behavior, run sensitive tests and the declared native slice/full run, and inspect actual output.
Done means all required artifacts exist and verify_research_release.py task exits 0 on the actual TASK_RECEIPT.json, with truthful coverage and disposition. Return real artifact paths, command results, decision-trail path and limitations. Keep runtime todos in the run's WORK_LOG.md and record playbook skips there.
...
Canonical source: [P2-19.md](/workspace/planning/phase-2/tasks/P2-19.md).

## P2-19 — Member two reasons context expert
...
Implement a separate MEMBER-TWO-REASONS expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
...
- [OUTCOMES.md](/workspace/planning/research-program/OUTCOMES.md)
- [DATA_CONTRACTS.md](/workspace/planning/research-program/DATA_CONTRACTS.md)
- [method-member-two-reasons.md](/workspace/wiki/method-member-two-reasons.md)
...
- `/workspace/implementation/src/trading_research/research/experts/methods/member.py`
- `/workspace/implementation/src/trading_research/research/experts/configs/method_member.json`
- `/workspace/implementation/tests/context_experts/test_p2_19.py`

A worker does not edit another task’s shared files. Request an explicit integration patch from the subphase coordinator for runner registration, imports or additive shared-schema changes; the coordinator records it and reruns the affected contract tests. Keep independently fitted artifacts separate even when calculators are shared.

### Implementation steps

1. Implement a separate MEMBER-TWO-REASONS expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
2. Build branch occurrence-grid and pre-opportunity conditional utility/path targets, selecting first future qualifying setup deterministically. Include complete no-setup rows and separate masks.
3. Consume causal upstream forecasts including OI B0/B1/B2 identities, preserve source clocks and selected-rule cutoff, run method-specific ablations/support and native examples.
4. Trace one actual output through its serialized schema, feature/stage parents and native receipt. Then run the verification below and write immutable evidence. A formula unit test alone does not complete a native-data or fitted-expert task.
...
- [ ] A01: The two reasons must have independent evidence parents.
- [ ] A02: A reaction-period HVN is not an independent second reason.
- [ ] A03: Touch history uses resolved prior reactions only.
- [ ] A04: No all-history selected rule or in-sample upstream forecast enters historical training/test rows.
- [ ] A05: A low-support branch returns the declared prior/baseline and all counts, not a fitted-success claim.
- [ ] A06: Evidence includes command exit codes, artifact hashes, coverage/unknown counts, runtime, actual output inspection and the task’s declared limitations. All predecessor receipts verify.
...
```bash
cd /workspace/implementation
.venv/bin/python -m pytest /workspace/implementation/tests/context_experts/test_p2_19.py -q
```

Then run the frozen engineering slice with the actual manifest and date list produced by the prerequisite (substitute the three ALL_CAPS paths/values; do not invent dates from outcomes):

```bash
/workspace/implementation/.venv/bin/python /workspace/implementation/tools/run_context_experts.py slice --run-root RUN_ROOT --manifest FROZEN_MANIFEST --dates FROZEN_DATES --task P2-19
```
...
```text
/poteto-mode new task. Implement this feature: P2-19 — Member two reasons context expert.
Read /workspace/planning/phase-2/tasks/P2-19.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
Use the coordinator's actual working root, code identity, predecessor receipt paths/hashes, frozen manifest, dates and run root. Resolve missing values from those artifacts; report unresolved fields to the coordinator instead of inventing them.
Use the parent Grok model for every pstack role (inherit-parent means omit model). Use the installed poteto-agent wrapper when supported. No nested delegation; the coordinator owns fresh review and shared-file integration. Respect its single-writer checkout assignment.
Follow the exact formulas, clocks, schemas, allowed paths, finite budgets and A01, A02, A03, A04, A05, A06, A07, A08 checks. Name the data shape, implement one vertical behavior, run sensitive tests and the declared native slice/full run, and inspect actual output.
Done means all required artifacts exist and verify_research_release.py task exits 0 on the actual TASK_RECEIPT.json, with truthful coverage and disposition. Return real artifact paths, command results, decision-trail path and limitations. Keep runtime todos in the run's WORK_LOG.md and record playbook skips there.
...
Canonical source: [P2-20.md](/workspace/planning/phase-2/tasks/P2-20.md).

## P2-20 — Keani context expert
...
Implement a separate KEANI-OPEN-ABOVE-VALUE expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
...
- `/workspace/implementation/src/trading_research/research/experts/methods/keani.py`
- `/workspace/implementation/src/trading_research/research/experts/configs/method_keani.json`
- `/workspace/implementation/tests/context_experts/test_p2_20.py`

A worker does not edit another task’s shared files. Request an explicit integration patch from the subphase coordinator for runner registration, imports or additive shared-schema changes; the coordinator records it and reruns the affected contract tests. Keep independently fitted artifacts separate even when calculators are shared.

### Implementation steps

1. Implement a separate KEANI-OPEN-ABOVE-VALUE expert configuration/artifact using its Phase 1.5 source adapter and the required method row in METHOD_EXPERTS.md. Keep generic fitting in the shared engine.
2. Build branch occurrence-grid and pre-opportunity conditional utility/path targets, selecting first future qualifying setup deterministically. Include complete no-setup rows and separate masks.
3. Consume causal upstream forecasts including OI B0/B1/B2 identities, preserve source clocks and selected-rule cutoff, run method-specific ablations/support and native examples.
4. Trace one actual output through its serialized schema, feature/stage parents and native receipt. Then run the verification below and write immutable evidence. A formula unit test alone does not complete a native-data or fitted-expert task.
...
- [ ] A01: Before A-period completion the complete-A predicate is unknown.
- [ ] A02: Sequence features cannot use a future developing VAH.
- [ ] A03: Six observations cannot satisfy the fitted-support gate.
- [ ] A04: No all-history selected rule or in-sample upstream forecast enters historical training/test rows.
- [ ] A05: A low-support branch returns the declared prior/baseline and all counts, not a fitted-success claim.
- [ ] A06: Evidence includes command exit codes, artifact hashes, coverage/unknown counts, runtime, actual output inspection and the task’s declared limitations. All predecessor receipts verify.
...
```bash
cd /workspace/implementation
.venv/bin/python -m pytest /workspace/implementation/tests/context_experts/test_p2_20.py -q
```

Then run the frozen engineering slice with the actual manifest and date list produced by the prerequisite (substitute the three ALL_CAPS paths/values; do not invent dates from outcomes):

```bash
/workspace/implementation/.venv/bin/python /workspace/implementation/tools/run_context_experts.py slice --run-root RUN_ROOT --manifest FROZEN_MANIFEST --dates FROZEN_DATES --task P2-20
```
...
```text
/poteto-mode new task. Implement this feature: P2-20 — Keani context expert.
Read /workspace/planning/phase-2/tasks/P2-20.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
Use the coordinator's actual working root, code identity, predecessor receipt paths/hashes, frozen manifest, dates and run root. Resolve missing values from those artifacts; report unresolved fields to the coordinator instead of inventing them.
Use the parent Grok model for every pstack role (inherit-parent means omit model). Use the installed poteto-agent wrapper when supported. No nested delegation; the coordinator owns fresh review and shared-file integration. Respect its single-writer checkout assignment.
Follow the exact formulas, clocks, schemas, allowed paths, finite budgets and A01, A02, A03, A04, A05, A06, A07, A08 checks. Name the data shape, implement one vertical behavior, run sensitive tests and the declared native slice/full run, and inspect actual output.
Done means all required artifacts exist and verify_research_release.py task exits 0 on the actual TASK_RECEIPT.json, with truthful coverage and disposition. Return real artifact paths, command results, decision-trail path and limitations. Keep runtime todos in the run's WORK_LOG.md and record playbook skips there.
...
Canonical source: [P2-21.md](/workspace/planning/phase-2/tasks/P2-21.md).
...
Acceptance amendment: `research-assurance-2026-09-14-v2`. Assigned cases: **S01, S02, S03, S07, S08, S11, S18, S19, S28, S30, S31, S32**. Use the exact probes, expected results and evidence in SILENT_FAILURES.md. Reuse current bound shared evidence where applicable; do not replace the task’s own sensitive/native check with a test count. Preserve prior attempts and produce the common task artifacts listed in TASK_GRAPH.json as well as the task-specific outputs below.
...
```text
/poteto-mode new task. Implement this feature: P2-21 — Build research-process context and risk overlay interfaces.
Read /workspace/planning/phase-2/tasks/P2-21.md and /workspace/planning/research-program/PSTACK_EXECUTION.md. Use the installed pstack router and the card's required contracts; this is execution of an existing specification.
Use the coordinator's actual working root, code identity, predecessor receipt paths/hashes, frozen manifest, dates and run root. Resolve missing values from those artifacts; report unresolved fields to the coordinator instead of inventing them.
Use the parent Grok model for every pstack role (inherit-parent means omit model). Use the installed poteto-agent wrapper when supported. No nested delegation; the coordinator owns fresh review and shared-file integration. Respect its single-writer checkout assignment.
Follow the exact formulas, clocks, schemas, allowed paths, finite budgets and A01, A02, A03, A04, A05, A06, A07, A08 checks. Name the data shape, implement one vertical behavior, run sensitive tests and the declared native slice/full run, and inspect actual output.
Done means all required artifacts exist and verify_research_release.py task exits 0 on the actual TASK_RECEIPT.json, with truthful coverage and disposition. Return real artifact paths, command results, decision-trail path and limitations. Keep runtime todos in the run's WORK_LOG.md and record playbook skips there.
Apply /workspace/planning/research-program/ASSURANCE.md and the card's assigned silent-failure cases: S01, S02, S03, S07, S08, S11, S18, S19, S28, S30, S31, S32. Produce EVIDENCE_MATRIX.json linking every required check to real code, executed commands, hashes and inspected output selectors. Show sensitive accepted/rejected controls; preserve missing/ambiguous data and all declared jobs. A pass flag or your own verifier alone cannot prove completion. Return the evidence for the coordinator's separate GATE_REVIEW.json; do not edit fixed independent checks to obtain a pass.
Preserve accepted Phase 1 evidence, raw sources, missing/ambiguous inputs and unsuccessful trials. Perform the local task only; no external publication, shipping workflow or later phase. Do not stop at a plan or a passing toy test.
```
