...
Source content SHA256: `a0152fd7f3cb00150a9d18de61ce358d6b7a7a74ccd49870ab4d5ae60be01a6f`.

Previous gate: **01-datasets-and-fitting**. External task dependencies: P15-02. Read and verify their actual receipts before implementation.
...
| --- | --- | --- |
| P2-09 — Implement native option/spot/OI adapters | P15-02 | [Task](/workspace/planning/phase-2/tasks/P2-09.md) |
...
Subphase: `02-native-options-baseline`. Dependencies: P15-02.
...
Acceptance amendment: `research-assurance-2026-09-14-v3`. Assigned cases: **S01, S02, S03, S07, S08, S13, S14, S25, S26**. Use the exact probes, expected results and evidence in SILENT_FAILURES.md. Reuse current bound shared evidence where applicable; do not replace the task’s own sensitive/native check with a test count. Preserve prior attempts and produce the common task artifacts listed in TASK_GRAPH.json as well as the task-specific outputs below.
