...
def main() -> int:
    ...
    try:
        ...
        false_phase = {"schema_version": "research-phase-receipt-v1", "phase": "phase-2",
        ...
        future["records"][0]["parents"][0].update(issue_at_ns=100, available_at_ns=100)
        ...
        for label, ref, expected in (("valid", early, "accepted"), ("late", late, "ContractError")):
            constructor("trade_" + label + "_evidence", lambda ref=ref: NativeTrade(
                "t", "NQ:test", 10, 10, Decimal("100"), 1, 1, ref), expected)
