...
- W:28 “[O137](/workspace/wiki/model-definition.md).” — Accurate engineering contracts, but hashes/immutable inventories/revision lineage are our implementation safeguards, not printed Stoic requirements.
...
- W:29 “[O146](/workspace/wiki/process-journal.md) · [O148](/workspace/wiki/research-cohort.md).” — Accurate causal record capability/limitation; source does not publish this exact ledger schema.
...
- W:30 “[O153](/workspace/wiki/outcome-metrics.md).” — Accurate supplied-outcome support and no universal entry rule.
...
- W:31 “[O157](/workspace/wiki/macro-indicators.md) · [O158](/workspace/wiki/macro-cycle.md) · [O159](/workspace/wiki/c-score.md) · [O160](/workspace/wiki/standardized-deviation.md) · [O161](/workspace/wiki/trend-strength.md) · [O162](/workspace/wiki/economic-release-vintage.md).” — Accurate conditional record support and missing formulas/series/thresholds; “Proprietary” is stronger than the guide establishes—custom and unpublished is the evidenced description.
