...
- `value.kz`: HVN = local maxima of the smoothed profile ≥ 1.5 × median bin volume; LVN = local minima ≤ 0.5 × median; ledge / shelf = sharp volume step ≥ 3× between adjacent 4-tick blocks (named approximation).
...
## Links
[open-location-switch](open-location-switch.md) · [absorption-and-big-trades](absorption-and-big-trades.md) · [cvd-variants](cvd-variants.md) · [options-nodes](options-nodes.md)
