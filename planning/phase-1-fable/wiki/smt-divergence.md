...
- Grid at the swept level after an SMT event; faithful disagreements = sessions where `flow.smt.trade.nq` and `flow.smt.ohlc.4` disagree on the presence of an event at the 6–9 edges.
