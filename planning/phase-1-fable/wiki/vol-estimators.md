...
- Tier-2: VIX level → expected ES daily points (12.5 ≈ 30, 16 ≈ 50, 22 ≈ 95) and intraday VIX / ES divergence reads `[VIX4 p.4 L50–56, p.6 L80–83]`; VIX / 16 daily move `[PINE Expected Volatility .txt]`; 252-day vol scaling clamp `[PINE NQ Stats Price Distributions.txt]`; prior assistant regime proposal (GK / YZ + profile shape + NDX IV + hysteresis) `[CEX L70]` (tier 4).
