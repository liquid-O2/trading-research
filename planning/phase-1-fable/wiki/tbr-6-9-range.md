...
## Faithful object
`range.6-9.published`: box = H/L of 06:00:00–08:59:59 ET on NQ 1-second bars (`cov.nq.ohlc1s`), EQ, Q25, Q75, open, close, −0.5 / +1.0 projections each side, 1.33 / 1.66 each side; widths `w.pts` = H−L, `w.pct` = (H−L)/close at 08:59:59 × 100 (named alternative `w.pct.0930open`), `w.rel-prior-rth` = (H−L)/(prior RTH H−L). Outcome window default 09:30–12:00, secondary 09:30–10:30 and 09:30–16:00.
...
- Width table: buckets fixed to his (0–0.3, 0.3–0.5, 0.5–0.8, 0.8–1.2, 1.2%+) `[XF p.24]`, plus `w.rel-prior-rth` buckets.
