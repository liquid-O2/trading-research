...
Source content SHA256: `e2ce3d49f9286942666fddaeb96fcf5a125b6519289bc128a9bc98ff29bb44ba`.
...
Acceptance amendment: `research-assurance-2026-09-14-v3`. Assigned cases: **S01, S02, S03, S21, S31**. Use the exact probes, expected results and evidence in SILENT_FAILURES.md. Reuse current bound shared evidence where applicable; do not replace the task’s own sensitive/native check with a test count. Preserve prior attempts and produce the common task artifacts listed in TASK_GRAPH.json as well as the task-specific outputs below.
