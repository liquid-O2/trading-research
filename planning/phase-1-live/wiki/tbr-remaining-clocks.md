...
## Faithful object
Each id: H / L / open / close of the window on NQ 1-second bars, EQ, Q25, Q75, −0.5 and 1.0 each side, 1.33 / 1.66 each side; `known_at` = window end. Outcome window (named default, not in the source): from window end to the next listed clock boundary (`range.midnight.0000-0030` → 03:00; `range.rth.0930-1000` → 12:00; `range.rth.1000-1030` → 12:00; `range.lunch.1200-1230` → 13:00; `range.moc.1500-1530` → 16:00), secondary to 16:00.
