...
# JETBUNDLE-STATES — full acquired Phase 1 measurement
...
| --- | --- | --- | --- | --- | --- | --- |
| B | context_or_research | 1742 | 0 | 0 | 0 | 43 |
| A | context_or_research | 1742 | 0 | 0 | 0 | 43 |
| D | context_or_research | 1742 | 0 | 0 | 0 | 42 |
| E | context_or_research | 1742 | 0 | 0 | 0 | 42 |
| W | context_or_research | 1742 | 0 | 0 | 0 | 45 |
| transition_observation | context_or_research | 1742 | 0 | 0 | 0 | 1730 |
...
Source: MATH pp.4–11; native provide/withdraw/consume and response observations → supplied B label/qualitative criteria; no invented classifier.
...
| scheduled RTH closure; no market-state observation | 12 |

## A

Source: MATH pp.4–11; native provide/withdraw/consume and response observations → supplied A label/qualitative criteria; no invented classifier.
...
Source: MATH pp.4–11; native provide/withdraw/consume and response observations → supplied D label/qualitative criteria; no invented classifier.
...
Source: MATH pp.4–11; native provide/withdraw/consume and response observations → supplied E label/qualitative criteria; no invented classifier.
...
Source: MATH pp.4–11; native provide/withdraw/consume and response observations → supplied W label/qualitative criteria; no invented classifier.
...
Source: FORMULAS:M10; transition_observation process/management unit.
...
| --- | --- | --- | --- | --- | --- |
| B | 0 | 0 | 0 | 7 | observed_subset_with_input_limits |
| A | 0 | 0 | 0 | 7 | observed_subset_with_input_limits |
| D | 0 | 0 | 0 | 7 | observed_subset_with_input_limits |
| E | 0 | 0 | 0 | 7 | observed_subset_with_input_limits |
| W | 0 | 0 | 0 | 7 | observed_subset_with_input_limits |
| unit: transition_observation | 0 | 0 | 0 | 0 | observed_subset_with_input_limits |

**B** — native provide/withdraw/consume and response observations → supplied B label/qualitative criteria; no invented classifier. Source: MATH pp.4–11. Scanner: `trading_research.research.method_pack.historical_process_scanners:scan_jetbundle`. Operational assumptions are frozen in the policy linked above; exact operands and their derivations are retained in the date-level evidence.

Remaining operand(s) `state`, `high_aggression`, `low_response_efficiency`, `low_aggression_both_sides`: dated actual B–A–D–E–W labels or published fully specified classifier/qualitative annotation records. Numeric source illustration does not publish classifier thresholds/priority. Native participation/efficiency runs; no classifier invented or trained. Source: MATH pp.9–11;O165–O166.

Inspected local evidence: ['planning/phase-1-live/wiki/auction-state.md', 'planning/phase-1-live/wiki/auction-state-transition.md'].

Recorded scope/record limits: dated actual B–A–D–E–W labels or published fully specified classifier/qualitative annotation records (7 job records).

**A** — native provide/withdraw/consume and response observations → supplied A label/qualitative criteria; no invented classifier. Source: MATH pp.4–11. Scanner: `trading_research.research.method_pack.historical_process_scanners:scan_jetbundle`. Operational assumptions are frozen in the policy linked above; exact operands and their derivations are retained in the date-level evidence.
...
**D** — native provide/withdraw/consume and response observations → supplied D label/qualitative criteria; no invented classifier. Source: MATH pp.4–11. Scanner: `trading_research.research.method_pack.historical_process_scanners:scan_jetbundle`. Operational assumptions are frozen in the policy linked above; exact operands and their derivations are retained in the date-level evidence.
...
**E** — native provide/withdraw/consume and response observations → supplied E label/qualitative criteria; no invented classifier. Source: MATH pp.4–11. Scanner: `trading_research.research.method_pack.historical_process_scanners:scan_jetbundle`. Operational assumptions are frozen in the policy linked above; exact operands and their derivations are retained in the date-level evidence.
...
**W** — native provide/withdraw/consume and response observations → supplied W label/qualitative criteria; no invented classifier. Source: MATH pp.4–11. Scanner: `trading_research.research.method_pack.historical_process_scanners:scan_jetbundle`. Operational assumptions are frozen in the policy linked above; exact operands and their derivations are retained in the date-level evidence.
...
**transition_observation** — transition_observation process/management unit. Source: FORMULAS:M10. Scanner: `trading_research.research.method_pack.native_discovery:extra_jet`. Operational assumptions are frozen in the policy linked above; exact operands and their derivations are retained in the date-level evidence.

Remaining operand(s) `state`, `high_aggression`, `low_response_efficiency`, `low_aggression_both_sides`: dated actual B–A–D–E–W labels or published fully specified classifier/qualitative annotation records. Numeric source illustration does not publish classifier thresholds/priority. Native participation/efficiency runs; no classifier invented or trained. Source: MATH pp.9–11;O165–O166.

Inspected local evidence: ['planning/phase-1-live/wiki/auction-state.md', 'planning/phase-1-live/wiki/auction-state-transition.md'].

Recorded scope/record limits: actual dated process/source records absent (7 job records); dated actual B–A–D–E–W labels or published fully specified classifier/qualitative annotation records (7 job records).

Native market/process research is executed; author-exact verdicts and faithful disagreements remain unknown. No comparison observation is represented as a fill. [Date-level evidence for this method](/workspace/implementation/reports/phase1-live/implementation-v2/run-2.0.0-r9/methods/JETBUNDLE-STATES.md) · [Software acceptance and remaining external inputs](/workspace/implementation/reports/phase1-live/implementation-v2/COMPLETION_REPORT.md).
