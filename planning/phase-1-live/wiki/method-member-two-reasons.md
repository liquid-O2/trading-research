...
# MEMBER-TWO-REASONS — full acquired Phase 1 measurement
...
| --- | --- | --- | --- | --- | --- | --- |
| resistance_short | entry_setup | 1742 | 1631 | 112 | 1525 | 99 |
| planned_return_long | entry_setup | 1742 | 1631 | 240 | 1401 | 99 |
...
Source: K10 pp.5–7,12; prior reaction + independently observed nearby minor HVN → current rejection → stop above rejection.

Setups per complete eligible session: 0.065. Observed setups per searched session: 0.064.
...
| --- | --- | --- | --- | --- | --- |
| 2020 | 262 | 245 | 25 | 24 | 15 |
| 2021 | 261 | 245 | 19 | 19 | 15 |
| 2022 | 260 | 245 | 9 | 9 | 14 |
| 2023 | 260 | 246 | 15 | 15 | 12 |
| 2024 | 262 | 244 | 17 | 16 | 16 |
| 2025 | 261 | 241 | 19 | 17 | 17 |
| 2026 | 176 | 165 | 8 | 6 | 10 |

| Horizon min | Complete futures | Incomplete futures | No price origin | Mean favorable points | Mean adverse points |
| --- | --- | --- | --- | --- | --- |
| 5 | 112 | 0 | 0 | 18.607 | 16.232 |
| 15 | 110 | 2 | 0 | 30.389 | 25.355 |
| 30 | 110 | 2 | 0 | 43.661 | 35.002 |
| 60 | 108 | 4 | 0 | 60.312 | 48.303 |

| Boundary outcome | n |
| --- | --- |
| invalidation_observed | 65 |
| objective_observed | 47 |
...
| --- | --- | --- | --- |
| invalidation_observed | 65 | 99.632 | 35.586 |
| objective_observed | 47 | 101.837 | 64.772 |
...
| --- | --- | --- | --- |
| NY_AM_0930_1200 | 93 | 1631 | 0.053 |
| NY_PM_1200_1600 | 19 | 1631 | 0.012 |
...
| --- | --- | --- | --- | --- |
| NY_AM_0930_1200 | 93 | 64.180 | 50.333 | invalidation_observed: 58; objective_observed: 35 |
| NY_PM_1200_1600 | 15 | 36.333 | 35.717 | invalidation_observed: 7; objective_observed: 12 |
...
Source: K10 pp.6–8,12; planned prior structure + independent minor HVN → second/distinct return → buyers absorb/hold → structural stop.

Setups per complete eligible session: 0.141. Observed setups per searched session: 0.138.

Searched session labels: 2020-01-01 through 2026-09-03. First/last session with complete branch inputs: 2020-01-03 / 2026-09-02. Interior unavailable sessions are excluded individually; these endpoints do not assert continuous coverage.

| Year | Searched | Eligible | Setups | Setups in eligible sessions | Limited sessions |
| --- | --- | --- | --- | --- | --- |
| 2020 | 262 | 245 | 49 | 49 | 15 |
| 2021 | 261 | 245 | 45 | 45 | 15 |
| 2022 | 260 | 245 | 29 | 28 | 14 |
| 2023 | 260 | 246 | 38 | 35 | 12 |
| 2024 | 262 | 244 | 42 | 39 | 16 |
| 2025 | 261 | 241 | 30 | 28 | 17 |
| 2026 | 176 | 165 | 7 | 6 | 10 |

| Horizon min | Complete futures | Incomplete futures | No price origin | Mean favorable points | Mean adverse points |
| --- | --- | --- | --- | --- | --- |
| 5 | 237 | 3 | 0 | 17.098 | 16.774 |
| 15 | 232 | 8 | 0 | 29.066 | 28.200 |
| 30 | 231 | 9 | 0 | 37.723 | 39.592 |
| 60 | 227 | 13 | 0 | 49.868 | 55.818 |

| Boundary outcome | n |
| --- | --- |
| invalidation_observed | 136 |
| objective_observed | 104 |
...
| Observed boundary classification | n | Mean seconds from decision | Median seconds |
| --- | --- | --- | --- |
| invalidation_observed | 136 | 91.735 | 21.971 |
| objective_observed | 104 | 128.127 | 36.305 |

A time attached to unresolved prior coverage is time to the observed batch only; it does not establish the population-first resolution time.

| Decision session | Observed setups | Eligible-session denominator | Setups per eligible session |
| --- | --- | --- | --- |
| NY_AM_0930_1200 | 187 | 1631 | 0.109 |
| NY_PM_1200_1600 | 53 | 1631 | 0.032 |

Clock-bin frequencies use the same complete branch-session denominator and count qualifying setups whose decision falls in that bin; they are not returns or independently selected cohorts.

| Decision session | Complete 60-min observations | Mean favorable points | Mean adverse points | Boundary classifications |
| --- | --- | --- | --- | --- |
| NY_AM_0930_1200 | 187 | 52.349 | 54.226 | invalidation_observed: 106; objective_observed: 81 |
| NY_PM_1200_1600 | 40 | 38.269 | 63.263 | invalidation_observed: 30; objective_observed: 23 |

The machine-readable decision-session results retain all four horizons, boundary-definition categories and resolution-time distributions.

| Exact limitation | Affected sessions |
| --- | --- |
| bar contact has no exact band execution | 1 |
| calendar_unverified | 65 |
| current input prefix has unknown intervals | 10 |
| same_contract_prior_scope_unknown | 37 |
