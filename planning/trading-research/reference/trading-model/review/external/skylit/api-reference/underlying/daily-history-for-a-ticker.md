...
````yaml /flowseeker-openapi.yaml get /v1/underlying/{ticker}/history
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/UnderlyingHistorySuccess'
        '400':
    ...
    UnderlyingHistorySuccess:
      ...
      properties:
        data:
          type: array
          items:
            $ref: '#/components/schemas/UnderlyingHistoryItem'
        meta:
