...
````yaml /flowseeker-openapi.yaml get /v1/underlying/{ticker}/by-strike/{strike}/expirations
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ExpirationDistributionSuccess'
        '400':
...
components:
  ...
  schemas:
    ExpirationDistributionSuccess:
      ...
      properties:
        data:
          $ref: '#/components/schemas/ExpirationDistributionResponse'
        meta:
    ...
    ExpirationDistributionResponse:
      ...
      properties:
        ...
        bars:
          type: array
          items:
            $ref: '#/components/schemas/ExpirationDistributionBar'
    Meta:
      type: object
      required:
        - timestamp
