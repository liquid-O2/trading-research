...
````yaml /flowseeker-openapi.yaml get /v1/flow/sector/{sector}
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/SectorFlowSuccess'
        '400':
...
components:
  schemas:
    SectorFlowSuccess:
      ...
      properties:
        data:
          $ref: '#/components/schemas/SectorFlowResponse'
        meta:
    ...
    SectorFlowResponse:
      ...
      properties:
        ...
        date:
          ...
          format: date
        metrics:
          $ref: '#/components/schemas/SectorMetrics'
        topContributors:
          type: array
          items:
        ...
        industryBreakdown:
          type: array
          items:
            $ref: '#/components/schemas/IndustryBreakdown'
        tickerCount:
          type: integer
          minimum: 0
    Meta:
