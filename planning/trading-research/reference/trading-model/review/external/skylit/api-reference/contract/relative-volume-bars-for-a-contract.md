...
````yaml /flowseeker-openapi.yaml get /v1/contract/{symbol}/rvol
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ContractRvolSuccess'
        '400':
...
components:
  ...
  schemas:
    ContractRvolSuccess:
      ...
      properties:
        data:
          $ref: '#/components/schemas/ContractRvolResponse'
        meta:
    ...
    ContractRvolResponse:
      ...
      properties:
        bars:
          type: array
          items:
            $ref: '#/components/schemas/ContractRvolBar'
        stats:
