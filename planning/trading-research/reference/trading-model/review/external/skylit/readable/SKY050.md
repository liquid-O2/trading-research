...
````yaml /flowseeker-openapi.yaml get /v1/contract-ratio/{symbol}
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ContractRatioSuccess'
        '400':
...
components:
  ...
  schemas:
    ContractRatioSuccess:
      ...
      properties:
        data:
          $ref: '#/components/schemas/ContractRatioResponse'
        meta:
    ...
    ContractRatioResponse:
      ...
      properties:
        ...
        totalPremium:
          type: number
        contractRatios:
          $ref: '#/components/schemas/ContractRatios'
        interpretation:
