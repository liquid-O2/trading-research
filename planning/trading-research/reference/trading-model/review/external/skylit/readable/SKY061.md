...
````yaml /flowseeker-openapi.yaml get /v1/underlying/{ticker}/by-strike
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/StrikeDistributionSuccess'
        '400':
...
components:
  ...
  schemas:
    StrikeDistributionSuccess:
      ...
      properties:
        data:
          $ref: '#/components/schemas/StrikeDistributionResponse'
        meta:
    ...
    StrikeDistributionResponse:
      ...
      properties:
        ...
        bars:
          type: array
          items:
            $ref: '#/components/schemas/StrikeDistributionBar'
    Meta:
      type: object
      required:
        - timestamp
