...
````yaml /flowseeker-openapi.yaml get /v1/contract/unusual-volume
openapi: 3.1.0
info:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/UnusualVolumeListSuccess'
        '400':
    ...
    UnusualVolumeListSuccess:
      ...
      properties:
        data:
          type: array
          items:
            $ref: '#/components/schemas/UnusualVolumeItem'
        meta:
