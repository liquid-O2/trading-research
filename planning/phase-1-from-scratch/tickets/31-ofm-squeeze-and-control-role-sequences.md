# 31: OFM, squeeze and control-role sequences

**What to build:** Compare faithful OFM, immediate squeeze, passive reclaim and balance-fade sequences with causal stage and memory/location variants.

**Blocked by:** [28: Absorption stages and confirmation failures](28-absorption-stages-and-confirmation-failures.md), [29: Refill touches with causal prior memory](29-refill-touches-with-causal-prior-memory.md), [30: Swing rails and protected-extreme lifecycles](30-swing-rails-and-protected-extreme-lifecycles.md)

**Definition blockers:** Q01, Q15, Q17 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S31](../PRD.md). **Wiki:** [origin control role flips](../wiki/origin-control-role-flips.md). **Contract:** [SPEC](../SPEC.md).
...
A nonreturning release is not discarded. A failed-start/retest sequence differs from immediate continuation; confirmation timestamp follows the confirming cross or renewal.
...
```sh
phase1 measure --slice 31 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/31/`. Each printed row must point to its actual generated report.
