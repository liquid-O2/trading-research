# 44: Options-node persistence and confluence ablations

**What to build:** Compare faithful disclosed node versions with strength, persistence, density and flow revisions, then measure rail/profile/absorption confluence on the same paths.

**Blocked by:** [03: A disclosed options wall with honest chain coverage](03-a-disclosed-options-wall-with-honest-chain-coverage.md), [04: RTH value profiles and 40/68/70% comparisons](04-rth-value-profiles-and-40-68-70-comparisons.md), [20: Local profile nodes, shelves and ledges](20-local-profile-nodes-shelves-and-ledges.md), [24: Delta-profile concentration and intrabar POC flips](24-delta-profile-concentration-and-intrabar-poc-flips.md), [28: Absorption stages and confirmation failures](28-absorption-stages-and-confirmation-failures.md), [37: Options flow revisions and delayed OI checks](37-options-flow-revisions-and-delayed-oi-checks.md), [43: Native and mapped cross-product node arrivals](43-native-and-mapped-cross-product-node-arrivals.md)

**Definition blockers:** Q01, Q23 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S44](../PRD.md). **Wiki:** [options node lifecycle](../wiki/options-node-lifecycle.md). **Contract:** [SPEC](../SPEC.md).

## Owned scope

Own screenshot/disclosed-node lifecycle, strength/density and confluence comparisons after Q23. Reuse ticket03’s disclosed exposure primitives and ticket37’s causal revisions.
...
A node disappearing before touch is counted as pre-touch invalidation. A later merge cannot rewrite old touches; modest nodes stay in the comparison rather than filtering only largest walls.
...
```sh
phase1 measure --slice 44 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/44/`. Each printed row must point to its actual generated report.
