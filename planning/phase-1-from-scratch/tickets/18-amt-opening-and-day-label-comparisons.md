# 18: AMT opening and day-label comparisons

**What to build:** Compare faithful AMT opening/day labels with continuous and snapshot labelers while keeping Jumbo labels separate.

**Blocked by:** [04: RTH value profiles and 40/68/70% comparisons](04-rth-value-profiles-and-40-68-70-comparisons.md), [16: ORB and IB formation-to-break reports](16-orb-and-ib-formation-to-break-reports.md)

**Definition blockers:** Q07 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S18](../PRD.md). **Wiki:** [auction day open types](../wiki/auction-day-open-types.md). **Contract:** [SPEC](../SPEC.md).
...
An11:00 developing D profile can later become a trend day without rewriting the11:00 feature. Unmatched source categories cannot be dropped to make percentages sum to100.
...
```sh
phase1 measure --slice 18 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/18/`. Each printed row must point to its actual generated report.
