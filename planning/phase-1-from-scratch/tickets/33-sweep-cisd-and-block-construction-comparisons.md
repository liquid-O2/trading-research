# 33: Sweep, CISD and block construction comparisons

**What to build:** Reconstruct source sweep/CISD/block variants and compare causal HTF, body/wick, midpoint and lifecycle alternatives on real revisits.

**Blocked by:** [30: Swing rails and protected-extreme lifecycles](30-swing-rails-and-protected-extreme-lifecycles.md)

**Definition blockers:** Q01, Q19 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S33](../PRD.md). **Wiki:** [sweep cisd blocks](../wiki/sweep-cisd-blocks.md). **Contract:** [SPEC](../SPEC.md).
...
A high break with close inside but body outside separates the source close-only and body-inside tests. Backdrawn origin does not equal confirmation time.
...
```sh
phase1 measure --slice 33 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/33/`. Each printed row must point to its actual generated report.
