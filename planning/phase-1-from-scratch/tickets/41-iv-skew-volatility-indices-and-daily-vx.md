# 41: IV, skew, volatility indices and daily VX

**What to build:** Compare acquired implied/realized scales and daily curve descriptors, retaining annualization and available proxy variants with honest coverage.

**Blocked by:** [03: A disclosed options wall with honest chain coverage](03-a-disclosed-options-wall-with-honest-chain-coverage.md), [05: GK, Yang–Zhang, RV and lagged HAR inputs](05-gk-yang-zhang-rv-and-lagged-har-inputs.md)

**Definition blockers:** Q22 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S41](../PRD.md). **Wiki:** [implied vx curve](../wiki/implied-vx-curve.md). **Contract:** [SPEC](../SPEC.md).
...
A same-day daily close is unavailable before its release. Unsupported VOLI/intraday VX remains unavailable; IV divided by 16 and bysqrt365 are not silently equated.
...
```sh
phase1 measure --slice 41 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/41/`. Each printed row must point to its actual generated report.
