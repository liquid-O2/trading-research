# 10: Extensions under explicit coordinate conventions

**What to build:** Compare source width, price-percent, CISD-anchor and volatility/quantile projection variants through ordered contact and return outcomes.
...
**Definition blockers:** Q01, Q04 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S10](../PRD.md). **Wiki:** [extension projections](../wiki/extension-projections.md). **Contract:** [SPEC](../SPEC.md).
...
For H100/L90, H+1.33W=113.3 while L+1.33W=103.3. These distinct coordinates cannot share an identity or be labeled a P-zone.
...
```sh
phase1 measure --slice 10 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/10/`. Each printed row must point to its actual generated report.
