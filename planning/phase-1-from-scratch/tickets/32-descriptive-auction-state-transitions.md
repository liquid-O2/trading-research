# 32: Descriptive auction-state transitions

**What to build:** Compare source-qualified B/A/D/E/W states and threshold/window/location variants using occupancy, dwell, transition and subsequent-path tables.

**Blocked by:** [22: Separate acceptance and failed-auction populations](22-separate-acceptance-and-failed-auction-populations.md), [27: Best-book renewal and withdrawal response](27-best-book-renewal-and-withdrawal-response.md), [28: Absorption stages and confirmation failures](28-absorption-stages-and-confirmation-failures.md)

**Definition blockers:** Q18 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S32](../PRD.md). **Wiki:** [auction state transitions](../wiki/auction-state-transitions.md). **Contract:** [SPEC](../SPEC.md).
...
Rows normalize over actual eligible transitions, including unknown states as declared. Declining aggression and failed replenishment retain different exhaustion labels; no fitted HMM is invoked.
...
```sh
phase1 measure --slice 32 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/32/`. Each printed row must point to its actual generated report.
