# 30: Swing rails and protected-extreme lifecycles

**What to build:** Compare source pivots and protected-extreme confirmations with paired-leg, prominence, bar and clean-edge variants.

**Blocked by:** [01: Published 06–09 range to a real path report](01-published-06-09-range-to-a-real-path-report.md), [24: Delta-profile concentration and intrabar POC flips](24-delta-profile-concentration-and-intrabar-poc-flips.md)
...
**PRD story:** [S30](../PRD.md). **Wiki:** [swing rails protected extremes](../wiki/swing-rails-protected-extremes.md). **Contract:** [SPEC](../SPEC.md).
...
A5/5pivot becomes known five bars after its extreme. Two independently latest extrema need not define one leg. A later no-retest cannot establish earlier protection.
...
```sh
phase1 measure --slice 30 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/30/`. Each printed row must point to its actual generated report.
