# 45: IOD, RFZ and cross-asset object-arrival responses

**What to build:** Compare sister-value, single-print and options-node arrivals with lead/lag, scale and breadth variants through later NQ responses.

**Blocked by:** [08: Continuous multiscale SMT on 3–4 markets](08-continuous-multiscale-smt-on-3-4-markets.md), [20: Local profile nodes, shelves and ledges](20-local-profile-nodes-shelves-and-ledges.md), [21: TPO excess, poor extremes and single-print fills](21-tpo-excess-poor-extremes-and-single-print-fills.md), [43: Native and mapped cross-product node arrivals](43-native-and-mapped-cross-product-node-arrivals.md), [44: Options-node persistence and confluence ablations](44-options-node-persistence-and-confluence-ablations.md)

**Definition blockers:** Q01, Q21 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S45](../PRD.md). **Wiki:** [cross asset object arrivals](../wiki/cross-asset-object-arrivals.md). **Contract:** [SPEC](../SPEC.md).
...
A sister touch before local arrival is distinct from simultaneous contact. Local nonarrival and no NQ reaction remain outcomes; object kinds cannot be paired solely by equal price.
...
```sh
phase1 measure --slice 45 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/45/`. Each printed row must point to its actual generated report.
