# 12: Jumbo P-zones against named approximations

**What to build:** Measure the disclosed faithful P-zone construction and distance/volatility/volume/history/anchor/node-snap experiments in one density-aware zone report.

**Blocked by:** [01: Published 06–09 range to a real path report](01-published-06-09-range-to-a-real-path-report.md), [04: RTH value profiles and 40/68/70% comparisons](04-rth-value-profiles-and-40-68-70-comparisons.md), [05: GK, Yang–Zhang, RV and lagged HAR inputs](05-gk-yang-zhang-rv-and-lagged-har-inputs.md)

**Definition blockers:** Q01, Q05 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S12](../PRD.md). **Wiki:** [jumbo p zones](../wiki/jumbo-p-zones.md). **Contract:** [SPEC](../SPEC.md).
...
With Q05 unresolved the faithful row is blocked and verification is nonzero. After resolution, an independently worked formula example must match; extension geometry cannot satisfy this fixture.
...
```sh
phase1 measure --slice 12 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/12/`. Each printed row must point to its actual generated report.
