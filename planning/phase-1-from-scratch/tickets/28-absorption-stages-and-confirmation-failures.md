# 28: Absorption stages and confirmation failures

**What to build:** Compare Absorption Zone+ and the discretionary stage sequence against trade-efficiency, BBO-resilience, pacing and bar/location variants.

**Blocked by:** [02: Trade and OHLC CVD on the same price paths](02-trade-and-ohlc-cvd-on-the-same-price-paths.md), [25: Large-print zones and size-normalized effort](25-large-print-zones-and-size-normalized-effort.md), [26: Footprint and same-price imbalance zones](26-footprint-and-same-price-imbalance-zones.md), [27: Best-book renewal and withdrawal response](27-best-book-renewal-and-withdrawal-response.md)

**Definition blockers:** Q01, Q15, Q16 in [QUESTIONS](../QUESTIONS.md)

**Status:** planned — no implementation or worker authorized in this session.

**PRD story:** [S28](../PRD.md). **Wiki:** [absorption stages](../wiki/absorption-stages.md). **Contract:** [SPEC](../SPEC.md).
...
A stage 1stall that never reaches stage 4 remains a failed/unconfirmed sequence. Three refresh events and three price ticks are different inputs; later opposite aggression cannot be backdated.
...
```sh
phase1 measure --slice 28 --verify
```

This is a proposed interface for later execution, not an existing or executed command. Planned report root: `reports/phase-1/28/`. Each printed row must point to its actual generated report.
