...
| [01-native-and-outcomes](/workspace/planning/phase-1-5/subphases/01-native-and-outcomes/RUNBOOK.md) | P15-02, P15-03 | Native MarketView and baseline parity/restart slice; ordered outcomes, coverage-aware labels, costed replay and chronological comparisons. |
| [02-source-reconstruction](/workspace/planning/phase-1-5/subphases/02-source-reconstruction/RUNBOOK.md) | P15-04 | Source-to-operator ledger for every remaining numerical gap, including EV, P-zone, KG1/gamma, auction and macro. Printed formulas are recovered where possible; unidentifiable proprietary values stay unknown. |
