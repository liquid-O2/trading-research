...
Snapshot: **2026-09-14**. Repository: `/workspace`, `liquid-O2/trading-research`.
...
| [03-primitives](/workspace/planning/phase-1-5/subphases/03-primitives/RUNBOOK.md) | P15-05–08 | 05: causal time/activity/balance formations and profiles. 06: CVD and resolved cohort memory. 07: explicit response state machines. 08: reference, memory and timing recipes plus the finite candidate bank. |
| [04-family-adapters](/workspace/planning/phase-1-5/subphases/04-family-adapters/RUNBOOK.md) | P15-09–16 | 09: Jumbo. 10: Green Bird failure. 11: Green Bird VWAP/scalps. 12: Sires. 13: Saint. 14: Member. 15: Keani. 16: Refilling/jetbundle/Stoic process and risk observations. Unchanged variants delegate to the baseline; changed variants preserve unchanged prerequisites. |
...
The current assurance identifier is **`research-assurance-2026-09-14-v3`** and plan version is **`research-plan-2026-09-14-v3`**. `00-foundation`, `01-native-and-outcomes` and `02-source-reconstruction` are closed on the identities in the tables below. Stop here. Do not start `03-primitives` in this run. The next eligible coordinator prompt is that subphase's runbook.
