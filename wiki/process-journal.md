# Thesis and execution journal

Object in [Sires — thesis, risk and order flow](method-sires-thesis-flow.md) · [Unnamed member — reaction area plus minor HVN](method-member-two-reasons.md) · [Stoic — data engine / quantifying fundamentals](method-stoic-data-engine.md).
...
**Record before use.** Author/process version, thesis/candidate IDs, reason and pre-entry confidence, context/regime, all attempts including losses/misses/breaches, costs/outcomes separately and later review change.
