...
[Full method measurements](/workspace/implementation/reports/phase1-live/historical-measurement/run-1.0.1/methods/GB-VWAP.md) · [Source conformance](/workspace/planning/phase-1-live/STRATEGY_SOURCE_CONFORMANCE.md) · [Research status](current-status.md).
...
| GB-VWAP | B0/B0.1 engineering slice with scalps (9 dates, not a family population) | see P15-11 BASELINE_PARITY | not claimed | D1 retest window kept separate from breakout context; full-history not run (p90>5s, P15-17 projection>24h) | implementation/reports/research-work/P15-11/ |
...
| 4 | Enter long and manage the continuation. The February 24 caption reports 150 points; the February 25 reply (post 2026623532096971050) reports a 30-point stop and a 100-point win; both are kept and neither is a fill ledger. | [O139](structural-risk.md) · [O141](trade-objective.md) · [O142](position-management.md) · [O150](order-lifecycle.md). Source-linked risk, objectives and lifecycle admission are implemented. This example's size and points do not supply a universal target or an actual historical fill. |
