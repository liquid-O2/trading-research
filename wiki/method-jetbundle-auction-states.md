...
| JETBUNDLE-STATES | P15-16 process observation (engineering slice, not a family population) | 0 entry setups | not claimed | B-A-D-E-W are not AMT day types; no entry denominator | implementation/reports/research-work/P15-16/ |
...
From [JETBUNDLE-STATES.md](/workspace/planning/research-program/reviews/astra-family-dossiers-2026-09-15/JETBUNDLE-STATES.md), ruled SD13: the p.10 state strip plots events 5,000–19,999 of the 20,000-event AAPL sample under an "AAPL quantiles" heuristic whose quantiles are unprinted; the p.11 matrix (B 0.98/0.00/0.00/blank/0.01; A 0.01/0.94/0.04/0.00/0.01; D 0.03/0.12/0.84/0.00/0.01; E blank/0.19/blank/0.81/blank; W 0.04/0.00/0.00/blank/0.95) has unprinted cells that are not zeros; the Sires application chart on p.14 is dated 2026-08-21 and the p.13 8R drawing (19.75-point stop, 158-point target) is illustrative; overlapping state predicates need an explicit tie rule before a categorical transition census.
